<template>
  <div class="">
    ...
    <label for="tel" class="font-weight-medium text-subtitle1 q-mb-md " style="display: block;">
      Номер телефона
      <q-input id="tel" outlined v-model="tel" placeholder="+998 (90) 123 45 67" class="q-mt-sm"
        mask="+998 (##) ###-##-##" fill-mask />
    </label>
